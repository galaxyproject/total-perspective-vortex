...
class TestMapperResubmission(IntegrationTestCase):
    default_tool_conf = os.path.join(
        os.path.dirname(__file__), "fixtures/resubmit/tool_conf_resubmit.xml"
    )
    ...
    def handle_galaxy_config_kwds(cls, config):
        ...
        config["tool_data_path"] = os.path.join(
            os.path.dirname(__file__), "fixtures/resubmit"
        )
        config["tool_data_table_config_path"] = os.path.join(
            os.path.dirname(__file__), "fixtures/resubmit/tool_data_tables.xml.sample"
        )
        config["data_manager_config_file"] = os.path.join(
            os.path.dirname(__file__), "fixtures/resubmit/data_manager_conf.xml.sample"
        )
        config["template_path"] = os.path.abspath(
