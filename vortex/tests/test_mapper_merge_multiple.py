...
class TestMapperRules(unittest.TestCase):
    ...
    def test_merge_remote_and_local(self):
        ...
        config_first = "https://github.com/usegalaxy-au/total-perspective-vortex/raw/main/" \
                       "vortex/tests/fixtures/mapping-merge-multiple-remote.yml"
        ...
        datasets = [mock_galaxy.DatasetAssociation("test", mock_galaxy.Dataset("test.txt", file_size=25))]
        ...
        datasets = [mock_galaxy.DatasetAssociation("test", mock_galaxy.Dataset("test.txt", file_size=7))]
